            ...
            <div className="bg-native-sand/50 p-8 rounded-3xl border border-native-black/5 my-12 shadow-inner">
              ...
              <ul className="space-y-6 text-lg">
                <li className="flex items-start">
                  ...
                  <span className="text-native-black/80"><strong>The Produce:</strong> Chosen for crunch, colour, and how well it carries spice after packing.</span>
                </li>
                <li className="flex items-start">
                  <span className="text-native-turquoise mr-4 text-2xl">*</span>
                  <span className="text-native-black/80"><strong>The Brine:</strong> Bright vinegar, salt, heat, and toasted spice balanced around the jar.</span>
                </li>
                <li className="flex items-start">
                  <span className="text-native-turquoise mr-4 text-2xl">*</span>
                  <span className="text-native-black/80"><strong>The Wait:</strong> Small batches are given time to settle before they leave the counter.</span>
                </li>
              </ul>
            </div>
