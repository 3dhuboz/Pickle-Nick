...
INSERT OR IGNORE INTO site_content (key, data, updated_at) VALUES (
  'main',
  '{"general":{"brandName":"Pickle Nick","logoUrl":"/brand/pickle-nick-seal-made-to-bite-back.png","faviconUrl":"/brand/pickle-nick-seal-made-to-bite-back.png","tagline":"Bold. Brined. Brilliant.","siteUrl":"https://picklenick.au","seoDescription":"Small-batch pickles, hot sauce, and bold jars with Nick''s mark.","email":"hello@picklenick.au","phone":"","address":"Australia","mascotUrl1":"","mascotUrl2":""},"home":{"heroHeading":"Bold. Brined. Brilliant.","heroSubheading":"Small-batch pickles & hot sauce","heroText":"Small-batch crunch, bold heat, and Nick''s mark on every jar.","heroImage":"","founderImage":"","galleryImage1":"","galleryImage2":"","galleryImage3":""},"about":{"heading":"About Pickle Nick","text":"We make small-batch pickles and hot sauces with real ingredients, sharp brine, and the kind of heat that bites back."}}',
  unixepoch() * 1000
);
