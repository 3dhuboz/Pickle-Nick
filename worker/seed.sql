...
INSERT OR IGNORE INTO site_content (key, data, updated_at) VALUES (
  'main',
  '{"general":{"brandName":"Pickle Nick","logoUrl":"","faviconUrl":"","tagline":"Bold. Brined. Brilliant.","siteUrl":"https://picklenick.au","seoDescription":"Custom pickles, hot sauce, and small-batch jars with Nick''s mark.","email":"hello@picklenick.au","phone":"","address":"Australia","mascotUrl1":"","mascotUrl2":""},"home":{"heroHeading":"Bold. Brined. Brilliant.","heroSubheading":"Custom pickles & hot sauce","heroText":"Small-batch crunch, custom heat, and Nick''s mark on every jar.","heroImage":"","founderImage":"","galleryImage1":"","galleryImage2":"","galleryImage3":""},"about":{"heading":"About Pickle Nick","text":"We make custom pickles and hot sauces with real ingredients, sharp brine, and the kind of heat that bites back."}}',
  unixepoch() * 1000
);
